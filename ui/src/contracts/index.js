...
class _MembershipCredential_0 {
  ...
  fromValue(value_0) {
    return {
      ...
      membershipId: _descriptor_4.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.secret).concat(_descriptor_4.toValue(value_0.membershipId));
  }
}

const _descriptor_5 = new _MembershipCredential_0();

class _ActionNullifier_0 {
  alignment() {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.secret).concat(_descriptor_0.toValue(value_0.actionId));
  }
}

const _descriptor_6 = new _ActionNullifier_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerMembership: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`registerMembership: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const result_0 = this._registerMembership_0(context,
                                                    partialProofData,
                                                    commitment_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      revokeMembership: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`revokeMembership: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const commitment_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
        ...
        const result_0 = this._revokeMembership_0(context,
                                                  partialProofData,
                                                  commitment_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      ...
      verifyMembership: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyMembership',
                                     'argument 1 (as invoked from Typescript)',
                                     'anonymous-membership-organisation.compact line 62 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(actionId_0),
            alignment: _descriptor_0.alignment()
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this._verifyMembership_0(context,
                                                  partialProofData,
                                                  actionId_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(0n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(adminKey_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _registerMembership_0(context, partialProofData, commitment_0) {
  ...
  _revokeMembership_0(context, partialProofData, commitment_0) {
  ...
  _verifyMembership_0(context, partialProofData, actionId_0) {
    ...
    const nullifierData_0 = { secret:
                                this._credential_0(context, partialProofData).secret,
                              actionId: actionId_0 };
    const nullifier_0 = this._persistentHash_1(nullifierData_0);
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'Membership already verified for this action');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'anonymous-membership-organisation.compact line 6 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    verifiedMembers: {
      ...
      member(...args_0) {
        ...
        if (!(key_0.buffer instanceof ArrayBuffer && key_0.BYTES_PER_ELEMENT === 1 && key_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'anonymous-membership-organisation.compact line 7 char 1',
                                     'Bytes<32>',
                                     key_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({ credential: (...args) => undefined });
